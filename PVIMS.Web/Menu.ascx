...
<div>
		...
		<ul>
			<li id="mnu_reportsystem" runat="server" visible="true">
                ...
                <ul>
			        ...
			        <li id="mnu_reportadverseevent" runat="server">
			        ...
			        <li id="mnu_reportadverseeventq" runat="server">
			        ...
			        <li id="mnu_reportadverseeventa" runat="server">
		...
		<ul>
			...
			<li id="mnu_active" runat="server">
                ...
                <ul>
			        ...
			        <li id="mnu_analyserview" runat="server">
	...
	<nav id="navPublisher" runat="server">
		...
		<ul>
			<li id="mnu_publishadmin" runat="server" visible="false">
