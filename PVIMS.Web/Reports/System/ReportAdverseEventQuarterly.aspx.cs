...
namespace PVIMS.Web
{
    public partial class ReportAdverseEventQuarterly : MainPageBase
    {
        ...
        {
            Master.MainMenu.SetActive("ReportAdverseEventq");
        }
        ...
        private void PopulateGrid()
        {
            ...
            var results = _reportService.GetAdverseEventQuarterlyItems(Convert.ToDateTime(searchfrom), Convert.ToDateTime(searchto));
