...
namespace PVIMS.Web
{
    public partial class CausalityNaranjo : MainPageBase
    {
        private int _rid;
        ...
        {
            Master.SetPageHeader(new Models.PageHeaderDetail() { Title = "Naranjo Causality Assessment", SubTitle = "", Icon = "fa fa-dashboard fa-fw", MetaPageId = 0 });
