<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageCareEvent.aspx.cs" Inherits="PVIMS.Web.ManageCareEvent" Title="Manage Care Events" MasterPageFile="~/Main.Master" %>
						...
						<div class="widget-body no-padding">
                            ...
                            <asp:Table id="dt_basic" runat="server" class="table table-striped table-bordered table-hover"  width="100%">
                                <asp:TableHeaderRow TableSection="TableHeader">
                                    <asp:TableHeaderCell Width="65%">Description</asp:TableHeaderCell> 
                                    <asp:TableHeaderCell Width="15%">Work Plans</asp:TableHeaderCell> 
