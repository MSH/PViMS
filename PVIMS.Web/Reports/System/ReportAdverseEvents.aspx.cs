...
namespace PVIMS.Web
{
    public partial class ReportAdverseEvents : MainPageBase
    {
        ...
        private void PopulateGrid()
        {
            ...
            if (results.Count > 0)
            {
                foreach (AdverseEventList item in results)
                {
                    row = new TableRow();
        ...
        protected void btnExportPdf_Click(object sender, EventArgs e)
        {
            ...
            linePosition += 24;
            gfx.DrawString("Stratify By : " + ddlStratify.SelectedItem.Text, fontr, XBrushes.Black, new XRect(columnPosition, linePosition, page.Width.Point, 20), XStringFormats.TopLeft);
            linePosition += 24;
