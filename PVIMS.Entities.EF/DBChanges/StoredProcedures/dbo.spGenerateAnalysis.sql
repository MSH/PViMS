...
**
***************************************************************************************************************************/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[GenerateContingencyAnalysis]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[GenerateContingencyAnalysis]
GO
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[spGenerateAnalysis]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[spGenerateAnalysis]
GO
