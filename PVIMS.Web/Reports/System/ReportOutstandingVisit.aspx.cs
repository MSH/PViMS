...
namespace PVIMS.Web
{
    public partial class ReportOutstandingVisit : MainPageBase
    {
        ...
        private void PopulateGrid()
        {
            ...
            var results = _reportService.GetOutstandingVisitItems(Convert.ToDateTime(searchfrom), Convert.ToDateTime(searchto), ddlFacility.SelectedValue == "" ? 0 : Convert.ToInt32(ddlFacility.SelectedValue));
            ...
            if (results.Count > 0)
            {
                foreach (OutstandingVisitList item in results)
                {
                    row = new TableRow();
                    ...
                    cell = new TableCell();
                    cell.Text = item.AppointmentDate.ToString("yyyy-MM-dd");
                    row.Cells.Add(cell);
        ...
        protected void btnExportXml_Click(object sender, EventArgs e)
        {
            ...
            string destName = string.Format("ReportOutstandingVisit_{0}.xml", DateTime.Now.ToString("yyyyMMddhhmmsss"));
            string destFile = string.Format("{0}{1}", documentDirectory, destName);
        ...
        protected void btnExportXls_Click(object sender, EventArgs e)
        {
            ...
            ws.Cells["A1"].Value = "Outstanding Visit Report for " + DateTime.Now.ToString("yyyy-MM-dd HH:mm");
