<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageEncounterType.aspx.cs" Inherits="PVIMS.Web.ManageEncounterType" Title="Manage Encounter Types" MasterPageFile="~/Main.Master" %>
						...
						<div class="widget-body no-padding">
                            ...
                            <asp:Table id="dt_basic" runat="server" class="table table-striped table-bordered table-hover"  width="100%">
                                <asp:TableHeaderRow TableSection="TableHeader">
                                    ...
                                    <asp:TableHeaderCell Width="40%">Help</asp:TableHeaderCell> 
                                    <asp:TableHeaderCell Width="15%">Work Plan</asp:TableHeaderCell> 
